...
class TestJobAdapter(unittest.TestCase):
    ...
    def test_determine_job_array_parameters(self):
        ...
        self.assertEqual(self.job_1.number_of_processes, 3)
        self.assertEqual(self.job_1.workers, 2)

    def test_determine_workers(self):
        """Test determining the number of workers"""
        self.job_2.number_of_processes = 1
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 1)

        self.job_2.number_of_processes = 2
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 1)

        self.job_2.number_of_processes = 3
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 2)

        self.job_2.number_of_processes = 5
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 2)

        self.job_2.number_of_processes = 9
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 2)

        self.job_2.number_of_processes = 10
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 4)

        self.job_2.number_of_processes = 100
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 9)

        self.job_2.number_of_processes = 1000
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 19)

        self.job_2.number_of_processes = 1e4
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 43)

        self.job_2.number_of_processes = 1e5
        self.job_2._determine_workers()
        self.assertEqual(self.job_2.workers, 96)

        self.job_2.number_of_processes = 1e6
        self.job_2._determine_workers()
