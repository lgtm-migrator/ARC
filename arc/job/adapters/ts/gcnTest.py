...
class TestGCNAdapter(unittest.TestCase):
    ...
    def test_has_gcn(self):
        """Test that GCN was successfully imported"""
        self.assertTrue(HAS_GCN)
    ...
    def test_gcn(self):
        ...
        self.assertLess(rxn1.ts_species.ts_guesses[0].execution_time.seconds, 300)  # 0:00:01.985336
