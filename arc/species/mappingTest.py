...
class TestMapping(unittest.TestCase):
    ...
    def test_map_ho2_elimination_from_peroxy_radical(self):
        ...
        # rxn_2 = ARCReaction(r_species=[r_1], p_species=[p_1, p_2])
        # self.assertEqual(rxn_2.atom_map[:5], [0, 1, 2, 8, 7])
        # self.assertIn(rxn_2.atom_map[5], [4, 5])
        # self.assertIn(rxn_2.atom_map[6], [3, 5])
        # self.assertIn(rxn_2.atom_map[7], [3, 4])
        # self.assertEqual(rxn_2.atom_map[8:], [6, 9])
        #
        # # Reverse HO2 elimination:
        # rxn_3 = ARCReaction(r_species=[p_1, p_2], p_species=[r_1])
        # self.assertEqual(rxn_3.atom_map[:3], [0, 1, 2])
        # self.assertIn(rxn_3.atom_map[3], [6, 7])
        # self.assertIn(rxn_3.atom_map[4], [5, 7])
        # self.assertIn(rxn_3.atom_map[5], [5, 6])
        # self.assertEqual(rxn_3.atom_map[6:], [8, 4, 3, 9])
        #
        # # Reverse HO2 elimination, reversed reactant order:
        # rxn_4 = ARCReaction(r_species=[p_2, p_1], p_species=[r_1])
        # self.assertEqual(rxn_4.atom_map[:6], [4, 3, 9, 0, 1, 2])
        # self.assertIn(rxn_4.atom_map[6], [6, 7])
        # self.assertIn(rxn_4.atom_map[7], [5, 7])
        # self.assertIn(rxn_4.atom_map[8], [5, 6])
        # self.assertEqual(rxn_4.atom_map[9], 8)
    ...
    #                                                 torsion=[atom_map[t] for t in rotor_dict['torsion']])
    #                        for rotor_dict in spc1.rotors_dict.values()]
    #     self.assertAlmostEqual(original_dihedrals_1[2], 67.81049913, 6)
    #     self.assertAlmostEqual(original_dihedrals_2[2], 174.65228274, 6)
    #     self.assertAlmostEqual(new_dihedrals_1[2], 121.231391, 4)
