...
class ARCReaction(object):
    ...
    def as_dict(self) -> dict:
        ...
        reaction_dict['r_species'] = [spc.as_dict(reset_atom_ids=True) for spc in self.r_species]
        reaction_dict['p_species'] = [spc.as_dict(reset_atom_ids=True) for spc in self.p_species]
    ...
    def determine_family(self,
        ...
        if self.rmg_reaction is not None:
            ...
            if self.family is None:
                rmg_reaction = self.rmg_reaction.copy()
                rmg_reaction = Reaction(reactants=rmg_reaction.products, products=rmg_reaction.reactants)
                self.family, self.family_own_reverse = rmgdb.determine_reaction_family(rmgdb=rmg_database,
